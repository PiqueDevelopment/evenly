...
function autoResizeColumnsD_F_G(sheet) {
  ...
  sheet.autoResizeColumn(5);  // Resize column E (Total Amount)
  ...
  // Add extra space to columns D, E, F, G, and H
  sheet.setColumnWidth(4, sheet.getColumnWidth(4) + 30);
  sheet.setColumnWidth(5, sheet.getColumnWidth(5) + 30);
  ...
  sheet.setColumnWidth(2, 400); // Set column B width to 300
